...
Source: [base/pkg/kusion_kubernetes/api/networking/v1/ingress_tls.k](https://github.com/KusionStack/konfig/tree/main/base/pkg/kusion_kubernetes/api/networking/v1/ingress_tls.k)
