...
Source: [base/pkg/kusion_kubernetes/api/core/v1/exec_action.k](https://github.com/KusionStack/konfig/tree/main//base/pkg/kusion_kubernetes/api/core/v1/exec_action.k)
