...
Source: [base/pkg/kusion_kubernetes/api/core/v1/flocker_volume_source.k](https://github.com/KusionStack/konfig/tree/main/base/pkg/kusion_kubernetes/api/core/v1/flocker_volume_source.k)
