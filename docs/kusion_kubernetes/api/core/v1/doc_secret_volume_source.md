...
Source: [base/pkg/kusion_kubernetes/api/core/v1/secret_volume_source.k](https://github.com/KusionStack/konfig/tree/main/base/pkg/kusion_kubernetes/api/core/v1/secret_volume_source.k)
...
|**optional**<br />Specify whether the Secret or its keys must be defined|bool|Undefined|optional|
|**secretName**<br />Name of the secret in the pod's namespace to use. More info: https://kubernetes.io/docs/concepts/storage/volumes\#secret|str|Undefined|optional|
