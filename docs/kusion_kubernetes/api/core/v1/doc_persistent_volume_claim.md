...
Source: [base/pkg/kusion_kubernetes/api/core/v1/persistent_volume_claim.k](https://github.com/KusionStack/konfig/tree/main//base/pkg/kusion_kubernetes/api/core/v1/persistent_volume_claim.k)
...
|**spec**<br />Spec defines the desired characteristics of a volume requested by a pod author. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes\#persistentvolumeclaims|[PersistentVolumeClaimSpec](doc_persistent_volume_claim_spec.md#schema-persistentvolumeclaimspec)|Undefined|optional|
