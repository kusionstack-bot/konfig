...
Source: [base/pkg/kusion_kubernetes/api/core/v1/config_map_volume_source.k](https://github.com/KusionStack/konfig/tree/main/base/pkg/kusion_kubernetes/api/core/v1/config_map_volume_source.k)
...
|**optional**<br />Specify whether the ConfigMap or its keys must be defined|bool|Undefined|optional|
