...
Source: [base/pkg/kusion_kubernetes/api/core/v1/resource_field_selector.k](https://github.com/KusionStack/konfig/tree/main//base/pkg/kusion_kubernetes/api/core/v1/resource_field_selector.k)
