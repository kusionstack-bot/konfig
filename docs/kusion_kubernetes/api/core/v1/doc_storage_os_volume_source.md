...
Source: [base/pkg/kusion_kubernetes/api/core/v1/storage_os_volume_source.k](https://github.com/KusionStack/konfig/tree/main//base/pkg/kusion_kubernetes/api/core/v1/storage_os_volume_source.k)
...
|**secretRef**<br />SecretRef specifies the secret to use for obtaining the StorageOS API credentials.  If not specified, default values will be attempted.|[LocalObjectReference](doc_local_object_reference.md#schema-localobjectreference)|Undefined|optional|
