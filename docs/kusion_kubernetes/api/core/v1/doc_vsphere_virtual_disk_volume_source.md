...
Source: [base/pkg/kusion_kubernetes/api/core/v1/vsphere_virtual_disk_volume_source.k](https://github.com/KusionStack/konfig/tree/main/base/pkg/kusion_kubernetes/api/core/v1/vsphere_virtual_disk_volume_source.k)
