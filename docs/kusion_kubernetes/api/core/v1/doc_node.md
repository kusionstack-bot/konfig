...
Source: [base/pkg/kusion_kubernetes/api/core/v1/node.k](https://github.com/KusionStack/konfig/tree/main//base/pkg/kusion_kubernetes/api/core/v1/node.k)
...
|**spec**<br />Spec defines the behavior of a node. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\#spec-and-status|[NodeSpec](doc_node_spec.md#schema-nodespec)|Undefined|optional|
