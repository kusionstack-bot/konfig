...
Source: [base/pkg/kusion_kubernetes/api/apps/v1/deployment.k](https://github.com/KusionStack/konfig/tree/main//base/pkg/kusion_kubernetes/api/apps/v1/deployment.k)
...
|**spec**<br />Specification of the desired behavior of the Deployment.|[DeploymentSpec](doc_deployment_spec.md#schema-deploymentspec)|Undefined|optional|
