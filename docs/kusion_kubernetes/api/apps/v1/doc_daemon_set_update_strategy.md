...
Source: [base/pkg/kusion_kubernetes/api/apps/v1/daemon_set_update_strategy.k](https://github.com/KusionStack/konfig/tree/main//base/pkg/kusion_kubernetes/api/apps/v1/daemon_set_update_strategy.k)
...
|**rollingUpdate**<br />Rolling update config params. Present only if type = "RollingUpdate".|[RollingUpdateDaemonSet](doc_rolling_update_daemon_set.md#schema-rollingupdatedaemonset)|Undefined|optional|
