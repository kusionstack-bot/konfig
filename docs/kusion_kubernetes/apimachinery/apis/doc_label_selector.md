...
Source: [base/pkg/kusion_kubernetes/apimachinery/apis/label_selector.k](https://github.com/KusionStack/konfig/tree/main//base/pkg/kusion_kubernetes/apimachinery/apis/label_selector.k)
...
|--------------------|----|-------------|--------|
|**matchExpressions**<br />matchExpressions is a list of label selector requirements. The requirements are ANDed.|[[apis.LabelSelectorRequirement](doc_label_selector_requirement.md#schema-labelselectorrequirement)]|Undefined|optional|
